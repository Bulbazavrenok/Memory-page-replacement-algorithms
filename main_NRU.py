...
class Kernel:
    ...
    def evict_page(self):
        candidates = []
        for frame, page in enumerate(self.physical_memory):
            if page is None:
                continue
        ...
        del self.page_table[evicted.pid, evicted.page_num]
    ...
    def handle_page_fault(self, pid, page_num):
        ...
        self.physical_memory[frame] = Page(pid, page_num)
...
print("Physical memory:", [page.page_num for page in kernel.physical_memory])
